...
class Model extends BaseModel
{
    ...
    * This is begining of additional custom methods added for application specific purpose
    * This methods are available to all models that extend codeigniter model
    
    */


     /**
     * This method can be used to save data to any table by passing the table name as first parameter and an array of key value pairs of data as the second parameter
     *
     * @param table|string $table name to save to
     * @param data|array   $data key value set to save
     *
     * @throws ReflectionException
     *
     */
    ...
    public function fetchTable($table, $keys = null)
    {
        $builder = $this->db->table($table);
