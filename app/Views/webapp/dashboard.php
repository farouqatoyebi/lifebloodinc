    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <?php 
                ...
                $auth_id = $basecontroller->getUserProfileInformationBasedOnType(session('acct_type'), session('auth_id'));

                $graphTitle = '';
                $ratedType = '';
                $lastFiveVisitors = [];

                if (session('acct_type') == 'hospital') {
                    $graphTitle = 'Your Top Blood Banks';
                    $ratedType = 'Blood Bank';
                    $lastFiveVisitors = $basecontroller->getLastFiveHospitalVisitors($auth_id->id);
                }
                elseif (session('acct_type') == 'blood-bank') {
                    $graphTitle = 'Your Top Hospitals';
                    $ratedType = 'Hospital';
                }
...
<?php 
    ...
    if (session('acct_type') == 'hospital') {
        $first_title = "Blood Requests Sent";
        $second_title = "Blood Offers Received";
    }
    elseif (session('acct_type') == 'blood-bank') {
...
<script>
    ...
    var chart_first_title = "<?php echo $first_title ?>";
    var chart_second_title = "<?php echo $second_title ?>";
